...
| "show docker logs for my-app" | `call_remote("scripts/docker_logs.sh", args=["my-app"])` |
| "last 100 lines of postgres logs" | `call_remote("scripts/docker_logs.sh", args=["postgres", "100"])` |
